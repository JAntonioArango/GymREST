...
class EntitiesTest {
    ...
    void user_is_persisted_and_retrieved_by_id() {
        ...
        assertThat(userRepo.findById(saved.getId()))
                .hasValueSatisfying(found ->
                        assertThat(found.getUsername()).isEqualTo("sara"));
    }
    ...
    void trainee_cascades_user_on_save() {
        ...
        Trainee t = new Trainee(null, LocalDate.of(1990, 3, 4),
                "Main St 1", u, new HashSet<>(), new HashSet<>());
    ...
    void trainer_and_trainee_are_linked_through_join_table() {
        ...
        Trainer coach = trainerRepo.save(
                new Trainer(null, cardio, coachUser, new HashSet<>(), new HashSet<>())
        );
