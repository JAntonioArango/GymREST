...
public class TrainerRepoTest {
    ...
    void findByTraineesUserUsername_ShouldReturnTrainers_WhenUserExists() {
        ...
        assertThat(trainers).extracting(trainer -> trainer.getUser().getUsername())
    ...
    void findByUserUsernameIn_ShouldReturnMatchingTrainers() {
        ...
        // When
        List<Trainer> trainers = trainerRepo.findByUserUsernameIn(Arrays.asList("trainer8", "trainer9"));
