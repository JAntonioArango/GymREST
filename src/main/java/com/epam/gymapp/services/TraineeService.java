...
public class TraineeService {
    ...
    public TraineeRegistrationDto register(CreateTraineeDto dto) {
        ...
        if (trainerRepo.existsByUserFirstNameAndUserLastName(
        ...
        return new TraineeRegistrationDto(
                u.getUsername(),
                u.getPassword());
    }
    ...
    public TraineeProfileDto updateProfile(String username, UpdateTraineeDto dto) {
        ...
        Trainee t = traineeRepo.findByUserUsername(username)
    ...
    public List<TrainerShortDto> replaceTrainers(String traineeUsername,
