...
public class TrainingService {
    ...
    public Page<TraineeTrainingDto> traineeTrainings(String traineeUsername,
                                                     TrainingFilter f,
                                                     Pageable pageable) {
            ...
            String trainingType)
    {
        ...
        public static final TrainingFilter EMPTY =
                new TrainingFilter(null, null, null, null, null);

        /* -------- helper accessors that normalise blank strings to null -------- */
        public String trainerNameOrNull()  { return blankToNull(trainerName);  }
        public String traineeNameOrNull()  { return blankToNull(traineeName);  }
    ...
    public Page<TrainerTrainingDto> trainerTrainings(String trainerUsername,
                                                     TrainingFilter f,
                                                     Pageable pageable) {
