...
public class TraineeController {
    ...
    public ResponseEntity<TraineeRegistrationDto> create(
            @Valid @RequestBody CreateTraineeDto body) {
    ...
    public ApiListWrapper<TraineeDto> list(
        ...
        return new ApiListWrapper<>(
                traineeService.list(PageRequest.of(page, size)).getContent());
    }
    ...
    public ApiListWrapper<TrainerShortDto> replaceTrainers(
        ...
        List<TrainerShortDto> out =
                traineeService.replaceTrainers(username, body.trainers());
